      ...
      content={
        <div className="legal-container">
          <div className="legal-body">
            ...
            <ol>
              <li>
                <a href="/terms#one">AGREEMENT TO TERMS</a>
              </li>
              <li>
                <a href="/terms#two">INTELLECTUAL PROPERTY RIGHTS</a>
              </li>
              <li>
                <a href="/terms#three">USER REPRESENTATIONS</a>
              </li>
              <li>
                <a href="/terms#four">USER REGISTRATION</a>
              </li>
              <li>
                <a href="/terms#five">PROHIBITED ACTIVITIES</a>
              </li>
              <li>
                <a href="/terms#six">USER GENERATED CONTRIBUTIONS</a>
              </li>
              <li>
                <a href="/terms#seven">CONTRIBUTION LICENSE</a>
              </li>
              <li>
                <a href="/terms#eight">GUIDELINES FOR REVIEWS</a>
              </li>
              <li>
                <a href="/terms#nine">MOBILE APPLICATION LICENSE</a>
              </li>
              <li>
                <a href="/terms#ten"> SOCIAL MEDIA</a>
              </li>
              <li>
                <a href="/terms#eleven"> SUBMISSIONS</a>
              </li>
              <li>
                <a href="/terms#twelve"> THIRD-PARTY WEBSITE AND CONTENT</a>
              </li>
              <li>
                <a href="/terms#thirteen"> SITE MANAGEMENT</a>
              </li>
              <li>
                <a href="/terms#fourteen"> PRIVACY POLICY</a>
              </li>
              <li>
                <a href="/terms#fifteen"> TERM AND TERMINATION</a>
              </li>
              <li>
                <a href="/terms#sixteen"> MODIFICATIONS AND INTERRUPTIONS</a>
              </li>
              <li>
                <a href="/terms#seventeen"> GOVERNING LAW</a>
              </li>
              <li>
                <a href="/terms#eighteen"> DISPUTE RESOLUTION</a>
              </li>
              <li>
                <a href="/terms#nineteen"> CORRECTIONS</a>
              </li>
              <li>
                <a href="/terms#twenty"> DISCLAIMER</a>
              </li>
              <li>
                <a href="/terms#twenty-one"> LIMITATIONS OF LIABILITY</a>
              </li>
              <li>
                <a href="/terms#twenty-two"> INDEMNIFICATION</a>
              </li>
              <li>
                <a href="/terms#twenty-three"> USER DATA</a>
              </li>
              <li>
                <a href="/terms#twenty-four">
                  {" "}
                  ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
                </a>
              </li>
              <li>
                <a href="/terms#twenty-five"> CALIFORNIA USERS AND RESIDENTS</a>
              </li>
              <li>
                <a href="/terms#twenty-six"> MISCELLANEOUS</a>
              </li>
              <li>
                <a href="/terms#twenty-seven"> CONTACT US</a>
              </li>
            </ol>
            ...
            <p>
              ...
              Nevada, United States and have our registered office at 645
              Painted Opus Pl, North Las Vegas, NV 89084. You agree that by
            ...
            <p>
              ...
              with these Terms of Use; (4) you are not under the age of 13; (5)
              ...
              not use the Site for any illegal or unauthorized purpose; and (8)
            ...
            <h2 className="my-36" id="fourteen">
              14. PRIVACY POLICY
            </h2>
            ...
            <p>
              ...
              consent, we will delete that information from the Site as quickly
              as is reasonably practical.
            </p>

            <h2 className="my-36" id="fifteen">
            ...
            <h2 className="my-36" id="seventeen">
              17. GOVERNING LAW
            </h2>
            ...
            <h2 className="my-36" id="eighteen">
            ...
            <p>
              ...
              appropriate, limited by the AAA Consumer Rules. The arbitration
            ...
            <p>
              ...
              state and federal courts located in Clark County, Nevada, and the
            ...
            <h2 className="my-36" id="nineteen">
              19. CORRECTIONS
            </h2>
            ...
            <h2 className="my-36" id="twenty-one">
            ...
            <h2 className="my-36" id="twenty-two">
              22. INDEMNIFICATION
            </h2>
            ...
            <h2 className="my-36" id="twenty-three">
              23. USER DATA
            </h2>
            ...
            <h2 className="my-36" id="twenty-four">
            ...
            <h2 className="my-36" id="twenty-five">
            ...
            <h2 className="my-36" id="twenty-six">
              26. MISCELLANEOUS
            </h2>
            ...
            <h2 className="my-36" id="twenty-seven">
              27. CONTACT US
            </h2>
